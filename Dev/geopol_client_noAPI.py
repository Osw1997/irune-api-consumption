...
class GeopolriskConsumer:
    ...
    def get_geopol_risk(self, list_tuples):
        total_result_df = pd.DataFrame({
            ...
            # "Value": [], 
            "reporterCode": [], 
            # "Total_value_YearProduct": [], "Share in % (production)": [], "Share HHI Production": [], 
            "HHI_production": [],
            # "classificationCode": [], 
            "cmdCode": [], 
            # "cmdDesc": [], "netWgt": [], "primaryValue": [], 
            # "Total_netWgt_YearProduct": [],
            # "Share in % (exports)": [], "Share HHI Exports": [], 
            "HHI_exports": [], "partnerDesc_import": [], "partnerISO_import": [], "netWgt_import": [], "netWgt_total_import": [],
